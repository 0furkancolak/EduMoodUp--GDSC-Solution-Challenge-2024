...
export default function TeacherEdit({teac,t}) {
                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="mt-5">
                                        <Input size={"md"} type="text" placeholder={teac.fullName} label={"Teacher Fullname"} />
                                    </div>

                                    <div className="mt-5">
                                        <Input size={"md"} type="text" placeholder={teac.email} label={"Email"} />
                                    </div>
